...
//import axios from 'axios';
 class Register extends React.Component{
    constructor(props){
        ...
        .then(response => response.json()).then(output => console.warn('thank you for registration')) //(this.state))
    ...
    render(){
     ...
     <div className="footer">
         <button type="submit" onClick={this.handleClick} className="btn">Register</button>
     </div>
