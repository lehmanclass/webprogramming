...
app.get(`/test_one`, (req, res) => {
    const {fruit, cake} = req.query;                                                // req.query, setting this object as the 

    res.json({                                                                      // res.json, allows the server to respond with json of the message that des
        message: {
            fruit,
            cake
        }
...
app.post('/test_two', (req, res) => {
    const {fruit, cake} = req.body;                                                 // the server is requesting 
